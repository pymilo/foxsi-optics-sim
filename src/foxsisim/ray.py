...
class Ray:
    ...
    def __init__(self,
        ...
        Parameters:
            ...
            tag:     used to identify the ray in some way, can store pointer to source object
            bounces: the number of times the ray has hit something
        '''
    ...
    def inRange(self,t):
        ...
        '''
        if t > 0.0000000000001: return True
        else: return False
    ...
    def plot3D(self, axes, color = 'r'):
        ...
        p1 = self.getPoint(0)
        p2 = self.getPoint(1)
        axes.plot3D((p1[0],p2[0]),(p1[1],p2[1]),(p1[2],p2[2]),'-'+color)
    ...
    def moveToZ(self,z):
        ...
        '''
        # if already there
        if self.pos[2] == z: return True
        # if ray cannot move in z direction
        if self.ori[2] == 0: return False
        # find t
